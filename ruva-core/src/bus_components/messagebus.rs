...
/// ## Example
/// ```rust,no_run
/// impl ruva::TEventBus<YourServiceResponse,YourServiceError> for CustomBus{
...
/// ```
///
/// If you pass service response and bus, `ruva::TEventBus` will be implemented for you.
/// ## Example
/// ```rust,no_run
/// init_event_handler!(
///     CustomBus,
...
macro_rules! init_event_handler {
	...
	(
		...
		$event_handler :expr,
			...
			impl ruva::TEventBus<$R,$E> for $Bus{
				fn event_handler(&self) -> &'static ruva::TEventHandler<$E>{
					&EVENT_HANDLERS
				}
			}
